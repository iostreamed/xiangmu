	...
	<div class="am-cf admin-main">
		...
		<div class="admin-content">
			<ol class="am-breadcrumb">
			  <li>位置：日志管理</li>
			  <li class="am-active">修改日志</li>
			</ol>
			<div class="am-g">
				<div class="am-u-lg-5 am-u-md-15 am-u-sm-centered">
					<form class="am-form m-form-horizontal"
						action="${pageContext.request.contextPath}/worklog_saveUpdate.action"
						method="post">
						<div class="am-g am-margin-top">
							...
							<div class="am-u-sm-10">
								<div class="am-form-group ">
									<div class="field">
									<input type="text" name="title" value="${worklog.title }" data-validate="required:标题不能为空">
									</div>
								</div>
							</div>
						...
						<div class="am-g am-margin-top">
							...
							<div class="am-u-sm-10">
								<div class="am-form-group ">
									<div class="field">
									<textarea rows="10" cols="20" class="xheditor" data-validate="required:日志内容不能为空" id="description" placeholder="日志内容" name="description">${worklog.description }</textarea>
									</div>
								</div>
							</div>
							<div class="am-u-sm-3"></div>
