...
<div class="right">
          ...
          <c:forEach var="bill" items="${billList }" varStatus="status">
				<tr>
					...
					<c:if test="${bill.isPayment == 2}">
						<span><a class="modifyBill" href="#" onclick='return confirm("订单已付款,不能修改")'><img src="${path}/statics/images/xiugai.png" alt="修改" title="修改"/></a></span>
					</c:if>
      ...
      <%@ include file="/WEB-INF/jsp/user/rollpage.jsp" %>
  </div>
</section>
